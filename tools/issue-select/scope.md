...
I have experience with Python, JavaScript, React, Node.js, PostgreSQL, GitHub, and basic testing with pytest. I have worked on web applications, REST APIs, database projects, and introductory AI and cybersecurity tasks. I want to improve my Python, debugging, testing, and open-source contribution skills. I prefer issues with clear requirements and a manageable scope, and I would like to avoid issues that require advanced machine learning knowledge or major architectural changes.
